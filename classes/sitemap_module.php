<?
	...
	class SiteMap_Module extends Core_ModuleBase {
		...
		public function extend_page_form($page, $context) {
			if ($context != 'content')
			{
				$page->add_form_field('sitemap_visible', 'left')->tab('Visibility')->renderAs(frm_checkbox);
				$page->add_form_field('sitemap_priority', 'right')->tab('Visibility')->renderAs(frm_text);
			}
		}
